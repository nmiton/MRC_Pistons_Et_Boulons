...
class CollaborateurController extends AbstractController
{
     ...
     * 
     * Fonction qui permet l'affichage de la page index de collaborateur
     * 
     * Cette page nous montre le listing des collaborateurs
     * 
     * @param CollaborateurRepository $collaborateurRepository
     * 
     * @return collaborateur/index.html.twig avec les données des collaborateurs dans la base de données
     */
     ...
     * 
     * @param Request $request qui permet de faire la requête de la modification
     * 
     ...
     * 
     * @param Request $request qui permet de faire la requête de la suppression
     * 
     * @param Collaborateur $collaborateur cette variable permet de savoir quel collaborateur nous avons choisi
     * 
